					...
					<div class="wrapper-body">
						<h3 class="d-inline-block mb-4">
							Content Management <img
								src="assets/icons/arrow-point-to-right.png"> </img> Privacy
							Policy
						</h3>
						...
						<div id="addBlogForm" class="blog_body col-12">
							<div class="accordion" id="accordionExample">
								...
								<c:forEach var="others" items="${others}">
									...
									<c:if test="${others.type == 'Policy'}">
										...
										<p class="text-dark font-weight-bold">Privacy ${count}</p>
										<div class="card">
							...
							<div class="container float-right">
								...
								<button type="button"
									...
									data-toggle="collapse" data-target="#demo">+ Add Policy</button>
								<div id="demo" class="collapse">
									<form action="savePrivacyPolicy" id="form1" name="addPolicy"
										method="POST">
										<input class="p-2 d-block inputBlogTitle w-100" type="text"
											name="title" id="title" placeholder="Title"
											value="${other.title}"> <input
											...
											value="${other.type}">
											<c:if test="${other.id != 0}">
											<input class="p-2 d-none inputBlogTitle w-100" type="number"
											name="id" id="idContent" placeholder="ID" value="${other.id}">
										</c:if>

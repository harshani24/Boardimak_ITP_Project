					...
					<div class="wrapper-body">
						<h3 class="d-inline-block mb-4">
							Content Management <img
								src="assets/icons/arrow-point-to-right.png"> </img> FAQs
						</h3>
						...
						<div id="addBlogForm" class="blog_body col-12">
							...
							<div class="container float-right">
								...
								<button type="button"
									...
									data-toggle="collapse" data-target="#demo">+ Add FAQ</button>
								<div id="demo" class="collapse">
									<form action="saveFA" id="form1" name="addPolicy" method="POST">
										...
										<input class="p-2 d-none inputBlogTitle w-100" type="text"
											name="author" id="authorContent" placeholder="ID"
											value="${other.author}">

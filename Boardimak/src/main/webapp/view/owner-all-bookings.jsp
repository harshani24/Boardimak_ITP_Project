			...
			<div class="row">
				...
				<div class="right-panel">
					<div class="wrapper-body">
						<h3>All Bookings</h3>
						<button class="btn-blue p-1 addBlogButtonss mr-2 float-right mb-2">
							<a href="/bookingsReportOwner" id="addBlogButton">Bookings Report</a>
						</button>
											...
											<tr>
												...
												<td>
													<ul class="list-actions">
														...
														<a
															href="/bookingsOwnerViewSingleBooking?id=${bookings.id}">
															<li><img src="assets/icons/eye.png"
																alt="View user icon "></li>
														</a>

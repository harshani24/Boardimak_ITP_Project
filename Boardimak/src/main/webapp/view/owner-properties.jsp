    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <form class="modal-form" method="POST" onsubmit="formValidation(event)" enctype="multipart/form-data" action="/owner/property">
                        <div class="row">
                            <div class="col-md-4">
                               <div class="form-group row">
                                 <input type="number" class="col-sm-11 disabled" id="ownerid" name="ownerId" value="${user.id }" placeholder="${user.id}" readonly>
                               </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group row">

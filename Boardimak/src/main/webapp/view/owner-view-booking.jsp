					...
					<div class=" row">
						<div id="addBlogForm" class="blog_body col-12">
							<div class="accordion" id="accordionExample">
								...
								<form action="/ownerChangesBookingStatus" class="" id="form1" method="post">

									<textarea class="mt-3 d-none p-2 w-100" name="massege"
							...
							value="${bookings.owner_name}"> --%>
									...
									<div class="buttonsINview d-inline-block float-right">
										<button type="submit" form="form1"
											...
											onclick="return  myFun()">Accept</button>


										<button type="submit" form="form1"
											class="btn btn-outline-danger p-1 addBlogButtonss"
											onclick="return myFuns()">Reject</button>
